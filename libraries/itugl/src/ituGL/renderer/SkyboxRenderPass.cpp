    ...
    , m_skyboxTextureLocation(-1)
{
    ...
    Shader vertexShader = ShaderLoader(Shader::VertexShader).Load("../../../../../exercises/exercise09/shaders/renderer/skybox.vert");
    Shader fragmentShader = ShaderLoader(Shader::FragmentShader).Load("../../../../../exercises/exercise09/shaders/renderer/skybox.frag");
